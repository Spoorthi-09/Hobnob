...
<body>
    <div class = "row">
        ...
        if(isset($_POST['update'])){
            ...
            if($u_image == ''){
                echo "<script>alert('Please select profile image on cliccking on your profile image')</script>";
                echo "<script>window.open('profile.php?u_id=$user_id','_self')</script>";
                exit();
    ...
    <div class = "row">
        ...
        <div class = "col-md-2" style = "background-color: #e6e6e6;text-align: center;left: 0.8%;border-radius: 5px;">
            <?php
                echo "
                    ...
                    <p><strong>User since: </strong> $register_date</p><br>
        ...
        <div class = "col-md-6">
            <!--display usr post-->
            <h3><u><center>My posts</center></u></h3>
